     ...
     for k=1:1:3
        for q=1:1:45
            if d1(q,1)==sorted_d1(k,1)
                ...
                title(['Dog: ',num2str(q),' Corr Score:', num2str(d1(q,1))]);
            end 
        end
     end
     ...
     for p=1:1:3
        for q=1:1:45
            if d2(q,1)==sorted_d2(p,1)
                subplot(2,2,p+1);
                imshow([origindogs_folder,'dog',num2str(q),'.png']);
                title(['Dog: ',num2str(q),' Corr Score:', num2str(d2(q,1))])
            end 
        end
     end
     ...
     for l=1:1:3
        for q=1:1:45
            if d3(q,1)==sorted_d3(l,1)
                subplot(2,2,l+1);
                imshow([origindogs_folder,'dog',num2str(q),'.png']);
                title(['Dog: ',num2str(q),' Corr Score:', num2str(d3(q,1))])
            end 
        end
     end
    elseif b==4
     for m=1:1:3
        for q=1:1:45
            if d4(q,1)==sorted_d4(m,1)
                subplot(2,2,m+1);
                imshow([origindogs_folder,'dog',num2str(q),'.png']);
                title(['Dog: ',num2str(q),' Corr Score:', num2str(d4(q,1))])                
            end 
        end
     end
     ...
     for n=1:1:3
        for q=1:1:45
            if d5(q,1)==sorted_d5(n,1)
                subplot(2,2,n+1);
                imshow([origindogs_folder,'dog',num2str(q),'.png']);
                title(['Dog: ',num2str(q),' Corr Score:', num2str(d5(q,1))])
            end 
        end
     end
    end
